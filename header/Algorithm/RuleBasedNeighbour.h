...
public:
	RuleBasedNeighbour(std::shared_ptr<DataHolderT<Data>> data, std::shared_ptr<DataHolderT<Data>> currentBest,  std::shared_ptr<InitialSolutionI<Data>> initSol);
...
template<class Data>
inline RuleBasedNeighbour<Data>::RuleBasedNeighbour(std::shared_ptr<DataHolderT<Data>> data, std::shared_ptr<DataHolderT<Data>> currentBest, std::shared_ptr<InitialSolutionI<Data>> initSol) : NeighbourI<Data>(data, currentBest, initSol)
{
...
template<>
inline void RuleBasedNeighbour<std::shared_ptr<DataHolder>>::afterOptimization()
{
	std::shared_ptr<BoundingBoxCreator> boxCreator = NeighbourI<std::shared_ptr<DataHolder>>::bestData_->getData()->getBoxCreator();
...
template<>
inline float RuleBasedNeighbour<std::shared_ptr<DataHolder>>::optimize() {
