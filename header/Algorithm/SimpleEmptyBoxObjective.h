...
template<class Data>
inline float SimpleEmptyBoxObjective<Data>::calculateObjectiveScore(std::shared_ptr<DataHolderT<Data>> dt)
{
	return 0.0f;
}

template<>
inline float SimpleEmptyBoxObjective<std::shared_ptr<DataHolder>>::calculateObjectiveScore(std::shared_ptr<DataHolderT<std::shared_ptr<DataHolder>>> dt)
{
