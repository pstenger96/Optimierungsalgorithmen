...
public:
	...
	void CreateInitialSolution(std::shared_ptr<DataHolderT<Data>> d, bool limitInitRectsPerBox) override;
};
...
template<class Data>
inline void SimpleInitialSolution<Data>::CreateInitialSolution(std::shared_ptr<DataHolderT<Data>> d, bool limitInitRectsPerBox)
{
}

template<>
inline void SimpleInitialSolution<std::shared_ptr<DataHolder>>::CreateInitialSolution(std::shared_ptr<DataHolderT<std::shared_ptr<DataHolder>>> d, bool limitInitRectsPerBox) {
