...
public:
	GeometryBasedOverlappingNeighbour(std::shared_ptr<DataHolderT<Data>> data, std::shared_ptr<DataHolderT<Data>> currentBest, std::shared_ptr<InitialSolutionI<Data>> initSol);
...
template<class Data>
inline GeometryBasedOverlappingNeighbour<Data>::GeometryBasedOverlappingNeighbour(std::shared_ptr<DataHolderT<Data>> data, std::shared_ptr<DataHolderT<Data>> currentBest, std::shared_ptr<InitialSolutionI<Data>> initSol) :
...
template<>
inline float GeometryBasedOverlappingNeighbour<std::shared_ptr<DataHolder>>::optimize() {
	return this->findNeighbour(false);
}


template<>
inline void GeometryBasedOverlappingNeighbour<std::shared_ptr<DataHolder>>::initParameters()
{
	t_ = 1;
	scoreShift_ = 0;
	rectPos_ = 0;
	...
	GeometryBasedNeighbourI<std::shared_ptr<DataHolder>>::numberOfAddedBoxes_ = 0;
	GeometryBasedNeighbourI<std::shared_ptr<DataHolder>>::iteration_ = 0;
...
template<>
inline void GeometryBasedOverlappingNeighbour<std::shared_ptr<DataHolder>>::beforeScoreCalculation(std::vector<class RectangleHolder*>* rectangles, std::vector<std::shared_ptr<BoundingBox>>& bBoxList, bool isTransgressionRect) {
...
template<>
inline void GeometryBasedOverlappingNeighbour<std::shared_ptr<DataHolder>>::decreaseT(std::vector<class RectangleHolder*>* rectangles, std::vector<std::shared_ptr<BoundingBox>>& bBoxList, bool isBetter)
{
	if (isBetter) {
